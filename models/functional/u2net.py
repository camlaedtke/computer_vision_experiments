...
def U2NET(input_height, input_width, n_classes):
    ...
    # -------------------- side output --------------------
    d1 = Conv2D(n_classes, kernel_size=3, padding="same", name="d1", dtype="float32")(hx1d)
    ...
    d0 = Conv2D(n_classes, kernel_size=1, name="d0", dtype="float32")(concatenate([d1, d2, d3, d4, d5, d6], axis=-1))
